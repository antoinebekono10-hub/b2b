                ...
                <div class="card-body install-card-body h-100 w-100 z-3 position-relative">
                  <!-- Top content -->
                    <div class="mar-ver pad-btm text-center">
                        ...
                        <h1 class="fs-21 fw-700 text-uppercase mt-2" style="color: #3d3d3d;">Activation</h1>
                        <p class="fs-12 fw-500" style="color:  #666; line-height: 18px;">
                            Cette étape n'exige plus de code Codecanyon. Laissez vide ou renseignez votre propre clé si vous en utilisez une.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('purchase.code') }}">
                        ...
                        <div class="form-group mb-3">
                            <label for="purchase_code" class="fs-12 fw-500" style="color: #666;">Purchase Code (facultatif)</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="purchase_code" name="purchase_code" placeholder="(optionnel)">
                        </div>
                        <div class="form-group">
                            <label for="system_key" class="fs-12 fw-500" style="color: #666;">System Key (facultatif)</label>
                            <input type="text" class="form-control rounded-2 border" style="height: 36px !important;" id="system_key" name="system_key" placeholder="(optionnel)">
                            <p class="text-right fs-11">Vous pouvez laisser vide si non utilisé.</p>
                        </div>
